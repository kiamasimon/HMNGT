...
public class BookingStudentsAdapter extends RecyclerView.Adapter<BookingStudentsAdapter.InvitesViewHolder> {

    private Context mCtx;
    private List<Student> studentList;

    public BookingStudentsAdapter(Context mCtx, List<Student> studentList ){
        this.mCtx = mCtx;
