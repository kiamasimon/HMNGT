...
import com.example.simon.hmngt.Activities.BookingDetailsActivity;
...
public class BookingsAdapter extends RecyclerView.Adapter<BookingsAdapter.RoomsViewHolder> {

    private Context mCtx;
    private List<Room> roomList;

    public BookingsAdapter(Context mCtx, List<Room> roomList){
        this.mCtx = mCtx;
